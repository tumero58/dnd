...
export const gridItemsDefault: IGridItem[] = [
  { id: 1, name: "Comp1", findIndex: 1 },
  { id: 2, name: "Comp2", findIndex: 2 },
  { id: 3, name: "Comp3", findIndex: 3 },
  { id: 4, name: "Comp4", findIndex: 4 },
];

export const components = [
  { component: <Comp1 />, id: 1 },
  { component: <Comp2 />, id: 2 },
  { component: <Comp3 />, id: 3 },
  { component: <Comp4 />, id: 4 },
...
export const renderPanel = (res: any, sizes: any, dispatch: any) => {
  return (
